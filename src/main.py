...
def analyse_fans(header, the_url=''):
    """
    ...
    for fan in fan_list:
        # 评估这个人的是我要找的人的可能性
        chance = analyse.evaluate(fan.__dict__)
        # print(fan.__dict__)
        if chance > 0:
            # 定义搜索关键词,越详细越准确越好
